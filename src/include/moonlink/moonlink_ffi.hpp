...
extern "C" [[nodiscard]] Result<Data *> moonlink_get_table_schema(Stream *stream, const char *schema,
                                                                  const char *table);

extern "C" [[nodiscard]] Result<Data *> moonlink_scan_table_begin(Stream *stream, const char *schema,
                                                                  const char *table);

extern "C" [[nodiscard]] Result<Void> moonlink_scan_table_end(Stream *stream, const char *schema, const char *table);
